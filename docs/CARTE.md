...
| `app/atelier_v3.html` + `app/atelier/` | 156 + 260 (css) + 1928 (js) | **l'atelier** — écrire et diagnostiquer une affaire, **un fichier par outil**. **Seule chose que ce mot désigne** (`docs/LEXIQUE.md`) | ne recopie rien (§12), *y compris de lui-même* |
